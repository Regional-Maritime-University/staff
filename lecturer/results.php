...
$lectuerId = $_SESSION["staff"]["number"] ?? null;
...
$deadlines = $lecturer->fetchPendingDeadlinesByClass(departmentId: $departmentId, lecturerId: $lectuerId);
