...
$activePage = "lecturer-profile";

// $lecturer = $admin->getLecturerProfile($_SESSION["staff"]["number"]);    
// $lecturerCourses = $admin->getLecturerCourses($_SESSION["staff"]["number"]);
// $lecturerPerformance = $admin->getLecturerPerformance($_SESSION["staff"]["number"]);
